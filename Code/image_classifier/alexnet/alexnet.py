...
if __name__ == '__main__':
    ...
    optimizer = optim.Adam(params=model.parameters(),lr=0.0001) # lr von 0.01 bei Adam unperformant (langsam und springt zu sehr), 0.001 besser, aber langsamer
    ...
    for epoch in range(EPOCH_NUM):
        ...
        print("Epoch", epoch, "finished in","%.2f"%((end-start)/60),"minutes with max","%.2f"%(max_vram_use / 1_000_000_000), "/", "%.2f"%(nv_info.total/ 1_000_000_000), "GB VRAM used - Train Loss:" ,"%.3f"%(epochloss/steps))
