...
class AgentPipeline:
    def __init__(self, brand: str, car_type=None, instruction: str='Write a sensational paragraph for an advertisement about a car brand based on the information provided.'):
        self.brand = brand
...
if __name__ == "__main__":
    agent_pipeline = AgentPipeline(brand='BMW')
