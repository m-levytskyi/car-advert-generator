...
class ArticleAgent:
    ...
    def get_information_with_wikipedia(self, task: str, instruction: str = "Perform the task based only on the context provided. Look at the prior responses as a reference.", prior_responses: str = "") -> str:
        """
    ...
    def create_paragraphs(self, tasks: List[str], instruction: str) -> List[str]:
        ...
        responses = ""
        for task in tasks:
            paragraph = self.get_information_with_wikipedia(task=task, instruction=instruction, prior_responses=responses)
