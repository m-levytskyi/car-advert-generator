...
# Example usage
directory_path = "/Users/johannesdecker/adl-gruppe-1/Code/dataset/data/DS1+DS2_brand_70"  # Replace with your CSV files directory
columns_to_consider = ["brand", "body_style"]  # Replace with your column names
output_directory = directory_path  # Specify your output directory
