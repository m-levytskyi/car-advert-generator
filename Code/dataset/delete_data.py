...
def delete_non_matching_subdirectories(csv_file, directory, column_name, distance_threshold=5):
    # Read the .csv file
...
# Example usage
csv_file = '/Users/johannesdecker/adl-gruppe-1/Code/dataset/data/DS1_Car_Models_3778/final_2.csv'  # Path to your .csv file
directory = '/Users/johannesdecker/adl-gruppe-1/Code/dataset/data/DS1_Car_Models_3778/test'  # Path to your directory containing subdirectories
